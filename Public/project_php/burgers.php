                ...
                <div class="popular_filter">                            
                    <ul>
                        ...
                        <?php 
                            ...
                            for ($i=1; $i < 99; $i++) { 
                                $sql = "SELECT * FROM categories WHERE parentID = 16 and id = ".$i;
                            // echo $sql;
                ...
                <div class="p_recype_item_main">
                    <div class="row p_recype_item_active">
                        <?php
                            ...
                            for ($i=0; $i <= 99; $i++) { 
                                $sql = "SELECT * FROM products, images, categories WHERE products.id = images.product_id and categories.id = products.category_id and categories.parentID = 16 and products.category_id = ".$i;
                                // echo $sql;
                                $result = $link->query($sql);
                                if ($result->num_rows > 0) {
                                    // output data of each row
                                    while($row = $result->fetch_assoc()) {?>
                                        <div class="col-md-6 <?php echo convert_number_to_words($i) ?>">
                                            <form method="post" action="burgers.php?action=add&codes=<?php echo $row["codes"]; ?>">
                                                <div class="media">
                                                    <div class="">
