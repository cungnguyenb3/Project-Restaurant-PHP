...
<head>
    ...
    <title>Admin - Redcayenne Restaurant</title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="../users/index.php" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-tasks"></i>Users</a>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" aria-expanded="false"> <i class="menu-icon fa fa-bar-chart"></i>Orders</a>
                        
                    </li>

                    <li class="menu-item-has-children dropdown">
                        <a href="#" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-area-chart"></i>Type user</a>
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="create.php" class="btn btn-success pull-right" style="margin-top: 1em;" >Add New Category</a>
                    </div>
                    <?php
                    // Include config file
