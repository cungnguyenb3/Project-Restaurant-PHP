                    ...
                    <div class="slider_text_box">
                       <div class="tp-caption bg_box" 
                        ...
                        <div class="tp-caption btn_text" 
                            ...
                            data-splitout="none" 
                            data-responsive_offset="on" 
                            data-elementdelay="0.05" ><a class="submit_btn_bg" href="./menu-list.php">Look Menu</a>
                        </div>
                    </div>
                </li>
                <li data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="600" data-rotate="0" data-saveperformance="off">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="service_item">
                    <a href="pizzas.php"><img src="img/service-icon/service-1.png" alt=""></a>
                    <a href="pizzas.php"><h3>Pizzas</h3></a>
                    ...
                    <a class="read_mor_btn" href="./pizzas.php">Read More</a>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="service_item">
                    <a href="coffee.php"><img src="img/service-icon/service-2.png" alt=""></a>
                    <a href="coffee.php"><h3>Coffee</h3></a>
                    <p>Lorem ipsum dolor sit amet, cont tempor incididunt ut labore dolor adipiscing elit, sed do eiusmod et  magna aliquaquat officia.</p>
                    <a class="read_mor_btn" href="./coffee.php">Read More</a>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="service_item">
                    <a href="burgers.php"><img src="img/service-icon/service-3.png" alt=""></a>
                    <a href="burgers.php"><h3>Burgers</h3></a>
                    <p>Lorem ipsum dolor sit amet, cont tempor incididunt ut labore dolor adipiscing elit, sed do eiusmod et  magna aliquaquat officia.</p>
                    <a class="read_mor_btn" href="./burgers.php">Read More</a>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="service_item">
                    <a href="drinks.php"><img src="img/service-icon/service-4.png" alt=""></a>
                    <a href="drinks.php"><h3>Drinks</h3></a>
                    <p>Lorem ipsum dolor sit amet, cont tempor incididunt ut labore dolor adipiscing elit, sed do eiusmod et  magna aliquaquat officia.</p>
                    <a class="read_mor_btn" href="./drinks.php">Read More</a>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="feature_item"  style="margin-top: 30px">
                                        <div class="feature_item_inner">
                                            ...
                                            <div class="icon_hover">
                                                ...
                                                <a href="./detail.php?id=<?php echo $row["product_id"] ?>"><i class="fa fa-search"></i></a>
